...
This expertly sequenced itinerary ensures safe adaptation to the high altitude while maximizing your experience of Ladakh's remarkable landscapes, ancient monasteries, and unique culture. Perfect for first-time visitors, this package provides both comfort and adventure.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Arrival at Kushok Bakula Rimpochee Airport, Leh",
      },
      {
        day: "Day 1",
        activity: "Traditional Ladakhi welcome and hotel transfer",
      },
      { day: "Day 1", activity: "Check-in and acclimatization briefing" },
      { day: "Day 1", activity: "Rest and hydration period" },
      {
        day: "Day 1",
        activity: "Optional gentle walk through Leh Market (if feeling well)",
      },
      ...
      { day: "Day 2", activity: "Breakfast at hotel" },
      {
        day: "Day 2",
        activity:
          "Visit Thiksey Monastery - morning prayers and monastery tour",
      },
      ...
      {
        day: "Day 3",
        activity: "Drive to Pangong Lake via Changla Pass (17,688 ft)",
      },
      ...
      {
        day: "Day 4",
        activity: "Optional Leh Market visit (flight timing dependent)",
      },
...
This thoughtfully sequenced itinerary ensures safe adaptation to the high altitude while maximizing your experience of the region's remarkable Buddhist heritage, dramatic landscapes, and unique culture. Perfect for those seeking a comprehensive introduction to Ladakh's diverse attractions.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 3",
        activity: "Drive to Nubra Valley via Khardung La Pass (18,380 ft)",
      },
      ...
      {
        day: "Day 4",
        activity: "Visit Sumur village and Samstanling Monastery",
      },
      ...
      {
        day: "Day 5",
        activity: "Free time for shopping (flight timing dependent)",
      },
...
This thoughtfully sequenced itinerary ensures safe adaptation to the high altitude while maximizing your experience of the region's remarkable Buddhist heritage, dramatic mountain passes, and unique natural wonders. Perfect for those seeking a complete Ladakh experience.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Check-in and essential acclimatization period",
      },
      { day: "Day 1", activity: "Rest and increased fluid intake" },
      {
        day: "Day 1",
        activity: "Optional gentle walk to Leh Main Market (if feeling well)",
      },
      {
        day: "Day 1",
        activity: "Visit to Leh Palace for sunset views (optional)",
      },
      { day: "Day 1", activity: "Dinner and trip briefing at hotel" },
      ...
      {
        day: "Day 2",
        activity: "Visit Hemis Monastery - largest monastic institution",
      },
      {
        day: "Day 2",
        activity: "Explore Thiksey Monastery and morning rituals",
      },
      ...
      {
        day: "Day 3",
        activity: "Visit Diskit Monastery and giant Buddha statue",
      },
      { day: "Day 3", activity: "Bactrian camel safari at Hunder sand dunes" },
      { day: "Day 3", activity: "Check-in at Nubra Valley accommodation" },
      ...
      {
        day: "Day 4",
        activity: "Scenic drive along Shyok River to Pangong Lake",
      },
      {
        day: "Day 4",
        activity: "Photo stops at dramatic gorges and viewpoints",
      },
      ...
      {
        day: "Day 5",
        activity: "Visit to Thiksey Monastery (if missed earlier)",
      },
...
This expertly sequenced itinerary ensures safe adaptation to the high altitude while maximizing your experience of the region's rich Buddhist heritage, dramatic mountain passes, and unique cultural traditions. Perfect for those seeking a thorough understanding of Ladakh's diverse attractions and hidden treasures.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Arrival at Kushok Bakula Rimpochee Airport, Leh (11,500 ft)",
      },
      {
        day: "Day 1",
        activity: "Traditional Ladakhi welcome and hotel transfer",
      ...
      {
        day: "Day 1",
        activity: "Optional gentle walk through Leh old town (if feeling well)",
      },
      { day: "Day 1", activity: "Visit to Central Asian Museum (optional)" },
      {
        day: "Day 1",
        activity: "Dinner and comprehensive trip briefing at hotel",
      },
      ...
      {
        day: "Day 6",
        activity: "Special farewell dinner with Ladakhi specialties",
      },
...
This expertly sequenced itinerary ensures safe adaptation to the high altitude while maximizing your experience of the region's Buddhist heritage, dramatic mountain passes, and untouched wilderness. Perfect for those seeking the ultimate Ladakh adventure spanning the region's full diversity of landscapes and cultures.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Traditional khatag welcome and hotel transfer",
      },
      {
        day: "Day 1",
        activity: "Check-in and essential acclimatization period",
      ...
      {
        day: "Day 1",
        activity: "Rest and increased fluid intake (4-5 liters recommended)",
      },
      {
        day: "Day 1",
        activity: "Optional gentle walk to Leh Main Bazaar (if feeling well)",
      },
      { day: "Day 1", activity: "Visit to Leh Jokhang temple (optional)" },
      {
        day: "Day 1",
      ...
      {
        day: "Day 2",
        activity: "Explore Thiksey Monastery and morning prayers",
      },
      ...
      {
        day: "Day 3",
        activity: "Visit Diskit Monastery with giant Buddha statue",
      },
      { day: "Day 3", activity: "Lunch break" },
      { day: "Day 3", activity: "Bactrian camel safari at Hunder sand dunes" },
      { day: "Day 3", activity: "Check-in at Nubra Valley accommodation" },
      ...
      {
        day: "Day 7",
        activity: "Return journey to Leh through Changthang plains",
      },
      ...
      {
        day: "Day 7",
        activity: "Special farewell dinner at organic restaurant",
      },
...
This expertly sequenced itinerary combines essential acclimatization with immersive cultural experiences while ensuring comfortable adaptation to high altitudes. Perfect for those seeking a deeper understanding of Ladakh's Buddhist heritage, traditional lifestyles, and living cultural traditions.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Traditional Ladakhi greeting and heritage hotel transfer",
      },
      {
        day: "Day 1",
        activity: "Check-in and essential acclimatization period",
      ...
      {
        day: "Day 1",
        activity: "Rest and hydration period (essential for adaptation)",
      },
      {
        day: "Day 1",
        activity: "Optional gentle stroll through Leh's old town",
      },
      { day: "Day 1", activity: "Visit to Leh Jokhang temple (optional)" },
      {
        day: "Day 1",
        activity: "Dinner and comprehensive cultural briefing at hotel",
      },
      ...
      {
        day: "Day 2",
        activity: "Visit Leh Palace with guided historical tour",
      },
      {
        day: "Day 2",
        activity: "Explore Namgyal Tsemo Gompa and 16th-century fort",
      },
      {
        day: "Day 2",
        activity: "Traditional Ladakhi lunch at authentic kitchen",
      },
      {
        day: "Day 2",
        activity: "Visit Central Asian Museum in restored caravan serai",
      },
      { day: "Day 2", activity: "Shanti Stupa at sunset" },
      { day: "Day 2", activity: "Evening visit to Sankar Gompa" },
      {
        day: "Day 2",
        activity: "Dinner with traditional Ladakhi music performance",
      },
      ...
      {
        day: "Day 3",
        activity: "Explore Likir Monastery and its towering Buddha statue",
      },
      ...
      {
        day: "Day 4",
        activity: "Drive to Nubra Valley via Khardung La (18,380 ft)",
      },
      ...
      {
        day: "Day 7",
        activity: "Visit nomadic Changpa settlements (seasonal)",
      },
      ...
      {
        day: "Day 8",
        activity: "Visit LAMO Center in restored heritage building",
      },
      {
        day: "Day 8",
        activity: "Special farewell dinner with cultural program",
      },
...
This expertly sequenced itinerary ensures safe adaptation to high altitudes while maximizing your experience of the region's Buddhist heritage, nomadic cultures, dramatic mountain passes, and pristine lakes. Perfect for those seeking the most complete exploration of Ladakh's diverse attractions, including restricted areas rarely visited by tourists.`,
    ...
    itinerary: [
      ...
      {
        day: "Day 1",
        activity: "Essential acclimatization and medical briefing",
      },
      {
        day: "Day 1",
        activity: "Rest and increased fluid intake (4-5 liters recommended)",
      ...
      {
        day: "Day 1",
        activity: "Early dinner and comprehensive trip briefing",
      },
      ...
      {
        day: "Day 2",
        activity: "Explore Namgyal Tsemo Gompa with panoramic views",
      },
      {
        day: "Day 2",
        activity: "Traditional Ladakhi lunch at rooftop restaurant",
      },
      {
        day: "Day 2",
        activity: "Visit Central Asian Museum in restored caravan serai",
...
packageSets.activities.packages = [
  {
    ...
    itinerary: [
      ...
      {
        day: "Trekking Expeditions",
        activity:
          "Markha Valley Trek – A moderate 7‑day journey through traditional Ladakhi villages, high mountain passes, and stunning valleys",
      },
      {
        day: "Trekking Expeditions",
        activity:
          "Chadar Trek – The legendary winter trek across the frozen Zanskar River (January‑February only)",
      },
      {
        day: "Trekking Expeditions",
        activity:
          "Stok Kangri Trek – For experienced trekkers seeking the thrill of summiting a 6,153m peak",
      },
      {
        day: "Trekking Expeditions",
        activity:
          "Hemis National Park Trails – Chance to spot the elusive snow leopard while exploring diverse terrains",
      },
      ...
      // Mountain Biking
      {
        day: "Mountain Biking",
        activity:
          "Experience the rush of cycling through some of the world's highest motorable passes",
      },
      ...
      { day: "Mountain Biking", activity: "Tanglang La (17,582 ft)" },
      {
        day: "Mountain Biking",
        activity:
          "Routes ranging from beginner‑friendly day trips to challenging multi‑day expeditions",
      },
      ...
      // River Rafting
      {
        day: "River Rafting",
        activity:
          "Navigate the mighty Indus and Zanskar rivers through spectacular gorges",
      },
      { day: "River Rafting", activity: "Beginner routes: Phey to Nimmo" },
      {
        day: "River Rafting",
        activity: "Intermediate routes: Alchi to Khaltse",
      },
      {
        day: "River Rafting",
        activity:
          "Advanced routes: The thrilling Zanskar river expedition (July‑August)",
      },

      // Mountaineering
      {
        day: "Mountaineering",
        activity: "Guided climbs on peaks ranging from 5,000m to 6,000m",
      },
      {
        day: "Mountaineering",
        activity:
          "Training courses for beginners at the Ladakh Mountaineering Center",
      },
      {
        day: "Mountaineering",
        activity: "Equipment rentals and expert guidance available",
      },
    ],
    includes: [
...

  {
    ...
    itinerary: [
      ...
      {
        day: "Monastery Experiences",
        activity:
          "Meditation retreats at Hemis, Thiksey, or Lamayuru monasteries",
      },
      {
        day: "Monastery Experiences",
        activity:
          "Festival participation - witness the colorful masked dances during Hemis Festival, Losar celebrations, or Gustor",
      },
      {
        day: "Monastery Experiences",
        activity:
          "Monk interactions - learn about Buddhist philosophy and daily monastic life",
      },

      // Village Homestays
      {
        day: "Village Homestays",
        activity: "Experience authentic Ladakhi hospitality",
      },
      {
        day: "Village Homestays",
        activity: "Participate in daily farming activities",
      },
      {
        day: "Village Homestays",
        activity: "Learn traditional cooking methods",
      },
      {
        day: "Village Homestays",
        activity:
          "Connect with local families in villages like Stok, Alchi, and Turtuk",
      },

      // Cultural Workshops
      {
        day: "Cultural Workshops",
        activity: "Traditional Ladakhi cooking classes",
      },
      { day: "Cultural Workshops", activity: "Thangka painting lessons" },
      {
        day: "Cultural Workshops",
        activity: "Pottery making in Likir village",
      },
      {
        day: "Cultural Workshops",
        activity: "Music and dance sessions with local artists",
      },
    ],
    includes: [
...

  {
    ...
    itinerary: [
      // High-Altitude Lakes
      {
        day: "High-Altitude Lakes",
        activity:
          "Pangong Lake – Marvel at the changing colors of this iconic lake",
      },
      {
        day: "High-Altitude Lakes",
        activity:
          "Tso Moriri – Bird watching and camping by this pristine lake",
      },
      {
        day: "High-Altitude Lakes",
        activity: "Tso Kar – Spot rare wildlife around this salt lake",
      },

      // Wildlife Safaris
      {
        day: "Wildlife Safaris",
        activity:
          "Guided tours through Hemis National Park – home to the elusive snow leopard",
      },
      {
        day: "Wildlife Safaris",
        activity: "Bird watching expeditions in Changthang Wildlife Sanctuary",
      },
      {
        day: "Wildlife Safaris",
        activity:
          "Photography tours focused on capturing Ladakh's unique biodiversity",
      },

      // Stargazing
      {
        day: "Stargazing",
        activity: "Experience some of the clearest night skies on Earth",
      },
      {
        day: "Stargazing",
        activity: "Guided astronomy sessions away from light pollution",
      },
      {
        day: "Stargazing",
        activity: "Astrophotography workshops under the Milky Way",
      },
    ],
    includes: [
...

  {
    ...
    itinerary: [
      ...
      {
        day: "Hot Springs",
        activity: "Rejuvenate in the natural hot springs of Panamik",
      },
      {
        day: "Hot Springs",
        activity: "Experience the healing mineral waters of Chumathang",
      },
      {
        day: "Hot Springs",
        activity:
          "Combine hot spring visits with guided meditation practices for holistic wellness",
      },
      ...
      // Yoga Retreats
      {
        day: "Yoga Retreats",
        activity:
          "Sunrise yoga sessions against breathtaking Himalayan backdrops",
      },
      {
        day: "Yoga Retreats",
        activity:
          "Multi-day wellness retreats combining yoga, meditation, and local nutritional guidance",
      },
      {
        day: "Yoga Retreats",
        activity:
          "Specialized breathing workshops tailored for high-altitude adaptation and inner clarity",
      },
    ],
    includes: [
...

  {
    ...
    itinerary: [
      ...
      {
        day: "Summer Highlights (May–September)",
        activity: "All major trekking routes open for adventure seekers",
      },
      {
        day: "Summer Highlights (May–September)",
        activity: "Vibrant green valleys and flower blooms in full glory",
      },
      {
        day: "Summer Highlights (May–September)",
        activity:
          "Attend most festivals and cultural events, including Hemis and Sindhu Darshan",
      },
      {
        day: "Summer Highlights (May–September)",
        activity:
          "Perfect weather for camping, rafting, and outdoor photography",
      },

      // Winter Magic (October–April)
      {
        day: "Winter Magic (October–April)",
        activity:
          "Experience the surreal Chadar Trek across frozen Zanskar River",
      },
      {
        day: "Winter Magic (October–April)",
        activity:
          "Greater chance of spotting elusive snow leopards in the wild",
      },
      {
        day: "Winter Magic (October–April)",
        activity: "Fewer tourists and tranquil snow-covered landscapes",
      },
      {
        day: "Winter Magic (October–April)",
        activity:
          "Celebrate authentic winter festivals like Losar and Spituk Gustor",
      },
    ],
    includes: [
  ...
  `,
    ...
    itinerary: [
      ...
      {
        day: "Sustainable Tourism Initiatives",
        activity:
          "Join eco-friendly farm tours and learn about Ladakh’s sustainable agriculture",
      },
      {
        day: "Sustainable Tourism Initiatives",
        activity:
          "Participate in local conservation projects such as reforestation or water conservation efforts",
      },
      {
        day: "Sustainable Tourism Initiatives",
        activity:
          "Engage in community-based tourism initiatives that directly support local livelihoods",
      },

      // Culinary Adventures
      {
        day: "Culinary Adventures",
        activity: "Learn to make traditional butter tea in a Ladakhi kitchen",
      },
      {
        day: "Culinary Adventures",
        activity:
          "Participate in apricot harvesting and sun-drying during the summer season",
      },
      {
        day: "Culinary Adventures",
        activity:
          "Hands-on cooking sessions: prepare skyu, thukpa, and momos with local families",
      },
      {
        day: "Culinary Adventures",
        activity:
          "Enjoy farm-to-table meals with seasonal local ingredients and age-old culinary wisdom",
      },
    ],
    includes: [
...
function openModal(setKey, id) {
  ...
  document.getElementById("modal-includes").innerHTML = pkg.includes
    .map((item) => `<li>${item}</li>`)
    .join("");

  // Add Excludes without cross marks
  document.getElementById("modal-excludes").innerHTML = pkg.excludes
    .map((item) => `<li>${item}</li>`)
    .join("");
...
function showDay(setKey, packageId, day, element) {
  ...
  document
    .querySelectorAll("#day-toggle button")
...
function showItinerary(itinerary, day) {
  ...
  document.getElementById("modal-itinerary").innerHTML = filteredItinerary
    .map(
      (item) =>
        `<tr>
